...
package com.example.taskappv2.Utils;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion){
        //DROP OLDER TABLES IF ALREADY EXISTING
    ...
    public List<ToDoModel> getAllTasks(){
        ...
        Cursor cur = null;
        db.beginTransaction(); //smt to do with saved states
        try{
            ...
            db.endTransaction(); //smt to do with saved states - preserve state if app closes accidentally
            //assert cur != null;
            cur.close();
        }
        return taskList;
